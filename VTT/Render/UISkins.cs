namespace VTT.Render
{
    ...
    public static class UISkins
    {
        ...
        public static void DarkRounded()
        {
            ...
            colors[(int)ImGuiCol.TabSelected] = new Vector4(0.20f, 0.25f, 0.29f, 1.00f);
            colors[(int)ImGuiCol.TabDimmed] = new Vector4(0.11f, 0.15f, 0.17f, 1.00f);
            colors[(int)ImGuiCol.TabDimmedSelected] = new Vector4(0.11f, 0.15f, 0.17f, 1.00f);
        ...
        public static void Source()
        {
            ...
            colors[(int)ImGuiCol.TabSelected] = new Vector4(0.59f, 0.54f, 0.18f, 1.00f);
            colors[(int)ImGuiCol.TabDimmed] = new Vector4(0.24f, 0.27f, 0.20f, 1.00f);
            colors[(int)ImGuiCol.TabDimmedSelected] = new Vector4(0.35f, 0.42f, 0.31f, 1.00f);
            ...
            colors[(int)ImGuiCol.NavCursor] = new Vector4(0.59f, 0.54f, 0.18f, 1.00f);
            colors[(int)ImGuiCol.NavWindowingHighlight] = new Vector4(1.00f, 1.00f, 1.00f, 0.70f);
            colors[(int)ImGuiCol.NavWindowingDimBg] = new Vector4(0.80f, 0.80f, 0.80f, 0.20f);
            colors[(int)ImGuiCol.ModalWindowDimBg] = new Vector4(0.80f, 0.80f, 0.80f, 0.35f);
        ...
        public static void HumanRevolution()
        {
            ...
            colors[(int)ImGuiCol.TabSelected] = new Vector4(0.78f, 0.55f, 0.21f, 1.00f);
        ...
        public static void DeepHell()
        {
            ...
            colors[(int)ImGuiCol.TabSelected] = new Vector4(0.84f, 0.66f, 0.66f, 0.66f);
            colors[(int)ImGuiCol.TabDimmed] = new Vector4(0.07f, 0.10f, 0.15f, 0.97f);
            colors[(int)ImGuiCol.TabDimmedSelected] = new Vector4(0.14f, 0.26f, 0.42f, 1.00f);
            colors[(int)ImGuiCol.PlotLines] = new Vector4(0.61f, 0.61f, 0.61f, 1.00f);
            colors[(int)ImGuiCol.PlotLinesHovered] = new Vector4(1.00f, 0.43f, 0.35f, 1.00f);
            ...
            colors[(int)ImGuiCol.TextSelectedBg] = new Vector4(0.26f, 0.59f, 0.98f, 0.35f);
            colors[(int)ImGuiCol.DragDropTarget] = new Vector4(1.00f, 1.00f, 0.00f, 0.90f);
            colors[(int)ImGuiCol.NavCursor] = new Vector4(0.41f, 0.41f, 0.41f, 1.00f);
            colors[(int)ImGuiCol.NavWindowingHighlight] = new Vector4(1.00f, 1.00f, 1.00f, 0.70f);
            colors[(int)ImGuiCol.NavWindowingDimBg] = new Vector4(0.80f, 0.80f, 0.80f, 0.20f);
            colors[(int)ImGuiCol.ModalWindowDimBg] = new Vector4(0.80f, 0.80f, 0.80f, 0.35f);
        }
        ...
        public static void VisualStudio()
        {
            ...
            colors[(int)ImGuiCol.NavCursor] = bgColor;
            colors[(int)ImGuiCol.DockingPreview] = panelActiveColor;
            colors[(int)ImGuiCol.Tab] = bgColor;
            colors[(int)ImGuiCol.TabSelected] = panelActiveColor;
            colors[(int)ImGuiCol.TabDimmed] = bgColor;
            colors[(int)ImGuiCol.TabDimmedSelected] = panelActiveColor;
        ...
        public static void UnityDark()
        {
            ...
            style.Colors[(int)ImGuiCol.TabDimmed] = new Vector4(0.08f, 0.08f, 0.09f, 1.00f);
            style.Colors[(int)ImGuiCol.TabDimmedSelected] = new Vector4(0.13f, 0.14f, 0.15f, 1.00f);
        ...
        public static void MSLight()
        {
            ...
            style.Colors[(int)ImGuiCol.TabSelected] = ImVec4(0.196078434586525, 0.407843142747879, 0.6784313917160034, 1.0);
            style.Colors[(int)ImGuiCol.TabDimmed] = ImVec4(0.06666667014360428, 0.1019607856869698, 0.1450980454683304, 0.9724000096321106);
            style.Colors[(int)ImGuiCol.TabDimmedSelected] = ImVec4(0.1333333402872086, 0.2588235437870026, 0.4235294163227081, 1.0);
            ...
            style.Colors[(int)ImGuiCol.NavCursor] = ImVec4(0.2588235437870026, 0.5882353186607361, 0.9764705896377563, 1.0);
        ...
        public static void Photoshop()
        {
            ...
            style.Colors[(int)ImGuiCol.TabSelected] = ImVec4(0.1921568661928177, 0.1921568661928177, 0.1921568661928177, 1.0);
            style.Colors[(int)ImGuiCol.TabDimmed] = ImVec4(0.09411764889955521, 0.09411764889955521, 0.09411764889955521, 1.0);
            style.Colors[(int)ImGuiCol.TabDimmedSelected] = ImVec4(0.1921568661928177, 0.1921568661928177, 0.1921568661928177, 1.0);
            ...
            style.Colors[(int)ImGuiCol.NavCursor] = ImVec4(1.0, 0.3882353007793427, 0.0, 1.0);
